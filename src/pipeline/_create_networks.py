...
def create_networks(args_dict: dict[str, Any]):
    ...
    t_dir = f"../{incubator}_data/monthly_data/{tech_type}/"
    s_dir = f"../{incubator}_data/monthly_data/{social_type}/"
    t_output_dir = f"../network_data/{incubator}_{tech_type}/"
    s_output_dir = f"../network_data/{incubator}_{social_type}/"
    mapping_out_source = f"../network_data/mappings/{incubator}-mapping-{versions['tech']}-{versions['social']}.csv"
