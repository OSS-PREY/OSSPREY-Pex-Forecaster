...
def segment_data(df: pd.DataFrame, incubator: str, time_strat: str, output_dir: str, author_field: str, ratios: dict) -> None:
	"""
...
def monthly_segmentation(args_dict):
	...
	monthly_data_dir = f"../{rd.incubator}_data/monthly_data/"
	...
	t_output_dir = f"{monthly_data_dir}{params_dict['tech-type'][rd.incubator]}/"
	s_output_dir = f"{monthly_data_dir}{params_dict['social-type'][rd.incubator]}/"
